"""
Django settings for djangokubes project.
...
SECRET_KEY = config('DJANGO_SECRET_KEY', default="testsecret")
...
WSGI_APPLICATION = 'djangokubes.wsgi.application'
